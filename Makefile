...
SDK_PATH = D:/Firmware/Intellisport/nrf51822_v9.0_sdk/
EXAMPLE_PATH = D:/Firmware/Intellisport/
...
C_SOURCE_FILES += sensors.c
C_SOURCE_FILES += adxl362.c
C_SOURCE_FILES += lsm6dsl.c
C_SOURCE_FILES += mlx90393.c
C_SOURCE_FILES += wdt.c
C_SOURCE_FILES += gpio.c
...
SDK_5_PATH = D:/Firmware/IntelliSport/nrf51822_v5.1_sdk/
...
INCLUDEPATHS += -I$(EXAMPLE_PATH)examples/bsp
